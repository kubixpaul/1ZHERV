        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    bool interaction = GameManager.Instance.interactiveMode;
                    interaction = GUILayout.Toggle(interaction, "", GUILayout.Width(20f));
                    if (GUI.changed)
                    {
                        GameManager.Instance.interactiveMode = interaction;
                    }
                }
                GUILayout.EndHorizontal();
                ...
                GUILayout.BeginHorizontal();
                {
                    ...
                    if (GUILayout.Button("M", GUILayout.Width(30f)))
                    {
                        SoundManager.Instance.masterMuted = !muted; // toggle on click
                    }
                }
                GUILayout.EndHorizontal();
